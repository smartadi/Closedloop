...
% ------------------------------------------------------------
We designed a feedforward controller to track a sinusoidal reference trajectory. Given a known trajectory to be tracked, we added a feedforward term that adjusts the reference signal sent to the PI controller to account for the response to a time-varying reference (Fig.~\ref{fig:figure5}). We present two example sessions in which we track a sinusoidal reference trajectory and compare the open-loop and closed-loop responses.
