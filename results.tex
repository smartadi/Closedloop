...
\todo{Spectral portion still to write: confirm absolute power spectra ($(\Delta F/F)^2$/Hz) are complete, then quantify what fraction of high-error closed-loop trials are attributable to 2--4\,Hz spontaneous fluctuations versus motion, with representative good/bad-trial spectral examples.}
