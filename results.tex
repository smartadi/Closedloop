...
\todo{COHORT 2026-09-07 "all the way": Fig 3 panels E,F,G,I,J,K and Fig 4 A--C regenerated at 15 sessions / 4 mice (new-rig AL\_0048/AL\_0051 added). STILL AT OLD COHORT --- re-run before submission: (1) the spontaneous-mean stationarity control below (currently "none of the 13 sessions", 8 pos/5 neg, drift 0.17 --- Fig S2 at 15); (2) the motion regression + Fig~\ref{fig:figure_motion} (currently n=9, slope +0.72; new mice have motion so n=11). Their numbers change and were NOT recomputed here.}
