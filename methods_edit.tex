...
\todo{LATENCY CONSISTENCY: (1) Results text says 47\,ms maximum and 80\,ms end-to-end — confirm both numbers are correct and do not contradict each other. (2) ``60 frames = 1\,s'' appears elsewhere in the analysis but at 35\,Hz, 60 frames $= 1.71$\,s — find and fix all frame-count-to-time conversions. (3) The staircase pattern in the latency histogram is attributed to a beat between trial-interval timing and the 35\,Hz frame clock — verify this numerically (expected beat frequency = $|1/T_{\mathrm{trial}} - 35|$\,Hz) before writing it into the manuscript (MEETINGS 2026-04-27).}
