...
\todo{TF FIT —OPEN ITEMS:Run TF fit across all 3 impulse sessions and add a comparison table of poles/time constants.}
...
We analysed controller performance across 13 sessions (two transgenic mice, with confirmed Chrimson expression). Within each session
