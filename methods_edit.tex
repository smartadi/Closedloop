...
80\,ms (Fig.~\ref{fig:2}C), arising from image transfer (${\sim}15$\,ms),
...
[0,\,0.3] \times [0,\,0.1]$ (Fig.~\ref{fig:4}A), then refined using
...
best-performing gain from the grid sweep (Fig.~\ref{fig:4}B). We
...
\begin{figure}
    ...
    \caption{Variance across trial-averaging based on batch size}
    \label{fig:S1}
\end{figure}